            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Button 
                  ...
                  className="w-full" 
                  disabled={isLoading}
                  onClick={() => window.location.href = '/api/auth/oauth?provider=microsoft'}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4 mr-2">
                    <path d="M0 0h11.377v11.372H0V0zm12.623 0H24v11.372H12.623V0zM0 12.623h11.377V24H0V12.623zm12.623 0H24V24H12.623V12.623z" fill="currentColor"/>
                  </svg>
                  Microsoft
                </Button>
              </div>
